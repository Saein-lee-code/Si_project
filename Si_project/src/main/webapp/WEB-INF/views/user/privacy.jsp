...
<link rel="stylesheet" href="/res/css/user/privacy.css" />
    
<div class="privacyContainer">
    <a href="/user/login"><img class="logo" src="/res/img/logo.png" alt="logo"/></a>
	<h1 class="title">Privacy Policy of SI University</h1>
	<h1 class="title shadow">Privacy Policy of SI University</h1>
	<div class="privacyContent">		
		SI University operates the Website Name website, which provides the SERVICE.<br><br>
		...
		The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which is accessible at Website URL, unless otherwise defined in this Privacy Policy.<br><br>
		
		<h2>Information Collection and Use</h2><br><br>
		...
		<h2>Links to Other Sites</h2><br><br>
		...
		If you have any questions or suggestions about our Privacy Policy, do not hesitate to contact us.<br><br>
	</div>
	<div class="btnContainer">
		<a href="/user/login"><button id="backBtn">Back</button></a>
	</div>
</div>
